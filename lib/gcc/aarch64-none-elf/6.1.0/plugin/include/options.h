...
enum opt_code
{
  ...
  OPT_mcpu_ = 1183,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1184,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1185,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1186,             /* -mgeneral-regs-only */
  OPT_mlittle_endian = 1187,                 /* -mlittle-endian */
  OPT_mlow_precision_recip_sqrt = 1188,      /* -mlow-precision-recip-sqrt */
  OPT_momit_leaf_frame_pointer = 1189,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1190,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1191,     /* -mpc-relative-literal-loads */
  OPT_mstrict_align = 1192,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1193,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1194,                     /* -mtls-size= */
  OPT_mtune_ = 1195,                         /* -mtune= */
  OPT_n = 1196,                              /* -n */
  OPT_no_canonical_prefixes = 1197,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1198,              /* -no-integrated-cpp */
  OPT_no_pie = 1199,                         /* -no-pie */
  OPT_nocpp = 1200,                          /* -nocpp */
  OPT_nodefaultlibs = 1201,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1202,                   /* -nostartfiles */
  OPT_nostdinc = 1203,                       /* -nostdinc */
  OPT_nostdinc__ = 1204,                     /* -nostdinc++ */
  OPT_nostdlib = 1205,                       /* -nostdlib */
  OPT_o = 1206,                              /* -o */
  OPT_p = 1207,                              /* -p */
  OPT_pass_exit_codes = 1208,                /* -pass-exit-codes */
  /* OPT_pedantic = 1209, */                 /* -pedantic */
  OPT_pedantic_errors = 1210,                /* -pedantic-errors */
  OPT_pg = 1211,                             /* -pg */
  OPT_pie = 1212,                            /* -pie */
  OPT_pipe = 1213,                           /* -pipe */
  ...
  OPT_r = 1226,                              /* -r */
  OPT_remap = 1227,                          /* -remap */
  OPT_s = 1228,                              /* -s */
  OPT_s_bc_abi = 1229,                       /* -s-bc-abi */
  OPT_save_temps = 1230,                     /* -save-temps */
  OPT_save_temps_ = 1231,                    /* -save-temps= */
  OPT_shared = 1232,                         /* -shared */
  OPT_shared_libgcc = 1233,                  /* -shared-libgcc */
  /* OPT_specs = 1234, */                    /* -specs */
  OPT_specs_ = 1235,                         /* -specs= */
  OPT_static = 1236,                         /* -static */
  OPT_static_libasan = 1237,                 /* -static-libasan */
  OPT_static_libgcc = 1238,                  /* -static-libgcc */
  OPT_static_libgcj = 1239,                  /* -static-libgcj */
  OPT_static_libgfortran = 1240,             /* -static-libgfortran */
  OPT_static_libgo = 1241,                   /* -static-libgo */
  OPT_static_liblsan = 1242,                 /* -static-liblsan */
  OPT_static_libmpx = 1243,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1244,          /* -static-libmpxwrappers */
  ...
  /* OPT_std_c__17 = 1252, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1253, */                /* -std=c++1y */
  OPT_std_c__1z = 1254,                      /* -std=c++1z */
  OPT_std_c__98 = 1255,                      /* -std=c++98 */
  OPT_std_c11 = 1256,                        /* -std=c11 */
  /* OPT_std_c1x = 1257, */                  /* -std=c1x */
  /* OPT_std_c89 = 1258, */                  /* -std=c89 */
  OPT_std_c90 = 1259,                        /* -std=c90 */
  OPT_std_c99 = 1260,                        /* -std=c99 */
  /* OPT_std_c9x = 1261, */                  /* -std=c9x */
  OPT_std_f2003 = 1262,                      /* -std=f2003 */
  OPT_std_f2008 = 1263,                      /* -std=f2008 */
  OPT_std_f2008ts = 1264,                    /* -std=f2008ts */
  OPT_std_f95 = 1265,                        /* -std=f95 */
  OPT_std_gnu = 1266,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1267, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1268, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1269,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1270,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1271, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1272, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1273,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1274,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1275,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1276, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1277, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1278,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1279,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1280, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1281, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1282,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1283, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1284, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1285, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1286,                     /* -std=legacy */
  OPT_symbolic = 1287,                       /* -symbolic */
  OPT_t = 1288,                              /* -t */
  OPT_time = 1289,                           /* -time */
  OPT_time_ = 1290,                          /* -time= */
